...
//  NLW IOS
//
//  Created by Juan Carlos on 17/12/24.
//
...
func fetchPlaces(for cateforyID: String, userLocation: CLLocationCoordinate2D) {
    guard let url = URL(string: "\(baseURL)/markets/category/\(cateforyID)") else  {
        return
    }
